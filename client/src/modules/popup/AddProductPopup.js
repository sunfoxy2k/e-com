...
const AddProductPopup = (props) => {
  const [data, setData] = useState(initData);
    const onClose = async () => {
      await api.ProductService.addNewProduct(data.name,data.price,data.quantity,data.ingredients,data.stock,data.image);
...
export default React.memo(AddProductPopup);