...
export default class OrderService {
   ...
   * @returns 
   */
  static async createNewOrder(OrderContent, CustomerName, RecipientName, Address, ContactNumber) {
   ...
   */
  static async makePayment(orderId, paymentInfo, cityId, districtId) {
